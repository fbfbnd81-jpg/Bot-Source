...
// ضع الآيدي (ID) الخاص بك هنا بدلاً من الصفر (اختياري لضمان دقة المطور 100%)
const DEV_USER_ID = 0; 
...
bot.on('message', async (ctx, next) => {
    try {
        ...
        // --- لوحة الأوامر (بأزرار شفافة: تظهر فقط للمطور Dev) ---
        ...
        if (text.startsWith('يوت ') || text.startsWith('بحث ')) {
            ...
            try {
                const searchRes = await fetch(`https://itunes.
